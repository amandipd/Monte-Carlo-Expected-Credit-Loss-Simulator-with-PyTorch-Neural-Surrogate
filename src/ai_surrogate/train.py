...
from config import MODELS_DIR, SYNTHETIC_DATASET_PATH
from ai_surrogate.dataset import ECLDataset, load_training_dataframe, split_features_labels
from ai_surrogate.model import ECLSurrogate
from ai_surrogate.scalers import save_scaler_artifact
